...
public class StatementTimeoutExecutor implements StatementExecutorInterface {
	...
	@Override
	public void create(final String instanceName, final String className, final Object... constructorArgs)
	...
	@Override
	public Object callAndAssign(final String symbolName, final String instanceName, final String methodsName,
	...
	@Override
	public Object call(final String instanceName, final String methodName, final Object... arguments)
			throws SlimException {
		Future<Object> submit = service.submit(new Callable<Object>() {
			@Override
			public Object call() throws Exception {
